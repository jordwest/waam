(module
 ...
 (data (i32.const 592) "\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "inputBuffer" (global $assembly/index/inputBuffer))
 (export "inputView" (global $assembly/index/inputView))
 ...
 (func $~lib/rt/__visit_globals (param $0 i32)
  ...
  global.get $assembly/index/inputView
  local.tee $1
  if
   local.get $1
   local.get $0
 ...
 (func $start:assembly/index
  ...
  global.set $assembly/index/inputView
  i32.const 0
  i32.const 4096
  i32.const 4
  i32.mul
 ...
 (func $assembly/index/process (param $0 i32) (result i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    local.set $4
    local.get $4
    global.get $assembly/index/bit_depth
    f32.convert_i32_s
    f32.mul
    f64.promote_f32
    local.set $5
